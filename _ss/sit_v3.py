...
class AudioVisualizer(QMainWindow):
    def __init__(self):
        ...
        self.window_size = 4096  # Increased for better frequency resolution
    ...
    def setup_ui(self):
        ...
        self.fft_plot.setXRange(20, 20000)  # Audible frequency range
        ...
        if self.input_device is not None and self.output_device is not None:
            try:
                def audio_callback(indata, outdata, frames, time, status):
                    ...
                    # Queue input data for visualization
    ...
    def update_visualizations(self):
        if not self.audio_queue.empty():
            ...
            if len(data) >= self.window_size:
                ...
                # Set fixed range for better visualization
                self.fft_plot.setYRange(-100, 0)  # dB range
